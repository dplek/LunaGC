...
public final class IrodoriFlowerDataOuterClass {
  ...
  public interface IrodoriFlowerDataOrBuilder extends
    ...
    /**
     * <code>repeated .ItemParam used_flower_list = 3;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int USED_FLOWER_LIST_FIELD_NUMBER = 3;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < usedFlowerList_.size(); i++) {
        output.writeMessage(3, usedFlowerList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < usedFlowerList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, usedFlowerList_.get(i));
      }
      {
        int dataSize = 0;
        for (int i = 0; i < finishedThemeList_.size(); i++) {
